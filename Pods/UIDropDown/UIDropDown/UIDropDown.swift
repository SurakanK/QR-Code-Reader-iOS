...
public class UIDropDown: UIControl {
    ...
    public var Statehiden = false

    public var dismissTable = false {
        didSet{
            if dismissTable {
                hideTable()
            }
    ...
    fileprivate func setup() {
        ...
        arrow.backgroundColor = UIColor.PrimaryColor
