...
class DetailTextController: UIViewController {
    ...
    var imageQR = UIImage()
    var imageicon = #imageLiteral(resourceName: "Text")
    ...
    let text_Text: UITextView = {
        let textView = UITextView()
        textView.textColor = UIColor.white
        textView.backgroundColor = UIColor.clear
        textView.font = UIFont.NunitoSansBold(size: 17)
    ...
    let btn_CopyText: UIButton = {
        ...
        button.layer.shadowRadius = 2
        button.layer.shadowOpacity = 6
        button.addTarget(self, action: #selector(CopyTextButtonClicker), for: .touchUpInside)
        return button
    }()
    ...
    func SettingElement(){
        ...
        text_Text.anchor(text_Subject.bottomAnchor, left: view_Discription.leftAnchor, bottom: nil, right: view_Discription.rightAnchor, topConstant: 0, leftConstant: 15, bottomConstant: 0, rightConstant: 15, widthConstant: 0, heightConstant: 100)
        text_Date.anchor(text_Text.bottomAnchor, left: view_Discription.leftAnchor, bottom: view_Discription.bottomAnchor, right: view_Discription.rightAnchor, topConstant: 5, leftConstant: 15, bottomConstant: 15, rightConstant: 15, widthConstant: 0, heightConstant: 0)
        ...
        btn_CopyText.anchor(btn_SavePNG.bottomAnchor, left: view.leftAnchor, bottom: nil, right: view.rightAnchor, topConstant: 10, leftConstant: 20, bottomConstant: 0, rightConstant: 20, widthConstant: 0, heightConstant: 50)
    }
    ...
    func SettingGoogleAdsBanner(){
        ...
        Google_Ads_banner.anchor(btn_CopyText.bottomAnchor, left: view.leftAnchor, bottom: view.safeAreaLayoutGuide.bottomAnchor, right: view.rightAnchor, topConstant: 30, leftConstant: 20, bottomConstant: 10, rightConstant: 20, widthConstant: 0, heightConstant: 0)
    ...
    func Process(){
        ...
        if StateView == "Create"{
            ...
            text_Text.text = "Text : " + TextView
            image_QRCode.image = generateQRCode(from: TextView)
    ...
    @objc func SavePNGButtonClicker(){
        if Google_Ads_interstitial_Save != nil {
    ...
    @objc func CopyTextButtonClicker(){
         UIPasteboard.general.string = TextView
        Create_AlertMessage(Title: "Copy text", TitleColor: .black, Message: "")
    }
...
extension DetailTextController : GADBannerViewDelegate{
...
extension DetailTextController : GADFullScreenContentDelegate{
